              ...
              {siblingItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`whitespace-nowrap text-sm font-sans px-3 py-2 rounded-sm transition-all duration-200 ${isActive
          ...
          <div className="flex-1 min-w-0 overflow-x-auto lg:overflow-x-visible">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
              <div>
                ...
                <p className="text-sm text-[#2A1C14]/50 font-sans mt-2">
                  {subcategoryProducts.length} handcrafted {subcategoryProducts.length === 1 ? "piece" : "pieces"} available
                </p>
              </div>
            </div>
            ...
            {subcategoryProducts.length === 0 ? (
              <div className="text-center py-24 border border-dashed border-gray-200 rounded-sm">
                ...
                <p className="text-sm text-[#2A1C14]/40 mt-2 font-sans">New handcrafted pieces are added regularly.</p>
                <Link
                  href={`/products/${category.slug}`}
